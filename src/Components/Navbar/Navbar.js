...
import { USER_PATH, HOME_PATH } from '../../consts/routes'
    ...
    return (
        <div className='navbar_container'>
            <div className='navbar_wrapper'>
                ...
                <span class="material-symbols-outlined cursorStyle" onClick={() => { history.push(USER_PATH) }}>
                    account_circle
                </span>
            </div>
        </div>
